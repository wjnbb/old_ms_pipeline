...
from src.detect_sample_groups import detect_single_sample_groups
...
groups = detect_single_sample_groups(names)
...
#Calculate FCs
FC_table = FC_SingleBio_vs_SingleControl(bio_stats, media_stats, BG_ignore="NA")
